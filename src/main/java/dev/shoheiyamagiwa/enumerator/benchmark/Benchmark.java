...
import dev.shoheiyamagiwa.enumerator.core.*;
...
public class Benchmark {
    ...
    private static void bitCombine() {
        ...
        for (int referenceCount : referenceCountValues) {
            ...
            boolean correct = java.util.Arrays.equals(outputUseScalar, outputUseVector) && java.util.Arrays.equals(outputDefScalar, outputDefVector);
